...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/surfinpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14796&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/surfinpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `surfinpy` can be installed with:

```
conda install surfinpy
```

It is possible to list all of the versions of `surfinpy` available on your platform with:
